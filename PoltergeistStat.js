...
class PoltergeistStat extends CharacterStat {
    constructor(gender, age) {
        super(gender, age);
        this.ageUp = 60;
        this.getStat = function () {
            if (age >= ageUp) {
                this.health = GetRandomNumber(5, 21) + (GetRandomNumber(0, 5) + (age - ageUp + 5));
            } else {
                this.health = GetRandomNumber(5, 21) - GetRandomNumber(0, 5);
            }

            if (age >= ageUp) {
                this.strength = GetRandomNumber(5, 21) + (GetRandomNumber(1, 5) + (age - ageUp + 5));
            } else {
            ...
            if (age >= 40) {
                this.intellegence = GetRandomNumber(5, 21) + (GetRandomNumber(0, 5) + (age - ageUp + 5));
            } else {
            ...
            if (age >= 40) {
                this.totalKnowledge = GetRandomNumber(5, 21) + (GetRandomNumber(0, 5) + (age - ageUp + 5));
            } else {
            ...
            if (age >= 40) {
                this.magicEnergy = GetRandomNumber(0, 6) + (GetRandomNumber(0, 3) + (age - ageUp + 1));
                this.magicControl = GetRandomNumber(0, 6) + (GetRandomNumber(0, 3) + (age - ageUp + 1));
            }
